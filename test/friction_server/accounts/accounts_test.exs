defmodule FrictionServer.AccountsTest do
  ...
  describe "users" do
    ...
    @valid_attrs %{email: "some email", image_url: "some image_url", name: "some name", password: "some password", password_hash: "some password_hash"}
